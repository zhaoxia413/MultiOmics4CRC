...
```{r fig.width=3, fig.height=3.2,dpi=600,fig.align='center',,out.width = "40%"}
...
```{r fig.width=7, fig.height=4,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "70%"}
...
```{r fig.width=6, fig.height=4,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "80%"}
...
```{r fig.width=9, fig.height=4,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "80%"}
...
```{r fig.width=6, fig.height=6,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "80%"}
plot_grid(p[[1]],p[[2]],p[[3]]+theme(legend.position = "right"),
          labels = c("A","B","C"), ncol =2, nrow = 2)
```


#### RF classifiers for each dataset
...
```{r fig.width=3, fig.height=3,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "50%"}
...
```{r fig.width=3, fig.height=5,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "50%"}
...
#### Gut FBratio and Response

```{r fig.width=5, fig.height=4,dpi=600,fig.align='center',warning=F,results='hold',message=FALSE,out.width = "50%"}
