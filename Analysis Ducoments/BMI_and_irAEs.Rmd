...
```{r fig.width=3, fig.height=3,dpi=600,fig.align='center',,out.width = "30%"}
...
```{r fig.width=6, fig.height=4,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "40%"}
