...
```{r fig.width=3, fig.height=3,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "60%"}
...
```{r fig.width=3, fig.height=3,dpi=600,fig.align='center',results='hold',message=FALSE,out.width = "30%"}
data<-fread("../Data/Data/publicData/gFBratio_subsetCRC_810samples.csv",data.table = F)
