...
```{r fig.width=7, fig.height=4, dpi=600,fig.align='center'}
...
```{r fig.width=3, fig.height=3,dpi=600,fig.align='center'}
...
```{r fig.width=10, fig.height=4,dpi=600,fig.align='center'}
...
```{r fig.height=4, fig.width=6, collapse=TRUE, dpi=600, paged.print=FALSE, results='hold', tidy=TRUE,fig.align='center'}
...
bar2<-ggplot(df,aes(Group,Desulfovibrionaceae,fill=Diarrhea_g))+
  ...
  theme(legend.key = element_blank(),
        axis.title.x = element_blank())
```
```{r fig.height=4, fig.width=6, dpi=600,fig.align='center'}
